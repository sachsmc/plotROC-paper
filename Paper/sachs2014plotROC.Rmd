...
```{r int-no, results = 'asis', eval = FALSE, verbatim = TRUE}
cat(
...
```{r print2, warning = FALSE, message = FALSE, fig.width = 6, fig.height = 6, fig.cap = "Using \\pkg{ggplot2} themes and annotations with \\pkg{plotROC} objects. \\label{annotate}"}
library(ggplot2)
plot_journal_roc(myrocplot, rocdata) + 
  theme_grey() + 
