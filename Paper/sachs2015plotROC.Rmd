...
\cline{2-4}
\multirow{2}{*}{$M$}& $M \geq c$ & true positive & false positive & test positive\\
\cline{2-4}
& $M < c$ & false negative & true negative & test negative\\
\cline{2-4}
\multicolumn{1}{c}{} & \multicolumn{1}{c}{Total} & \multicolumn{1}{c}{disease positive} & \multicolumn{1}{c}{disease negative} & \multicolumn{1}{c}{total}\\
\end{tabular}
...
```{r print, eval = 1, fig.width = 6, fig.height = 6, fig.cap = "Illustration of ROC curve plot generated by \\pkg{plotROC} for use in print. \\label{first}"}
