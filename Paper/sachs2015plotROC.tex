...
Users can install the latest version of \pkg{plotROC} from github, as
shown below. The package will appear on the Comprehensive \proglang{R}
...
October 19, 2015, \pkg{plotROC} also requires the development version of
\pkg{ggplot2} also available from github.
...
features of \pkg{ggplot2}. We have implemented the empirical ROC curve
...
accessible and familiar to most \proglang{R} users. Then, the
\proglang{JavaScript} adds a layer of interactivity to the rendered
figures.
